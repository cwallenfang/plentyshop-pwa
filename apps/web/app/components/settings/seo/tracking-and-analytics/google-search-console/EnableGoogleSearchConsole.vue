<template>
  <div class="py-2">
    <div class="flex justify-between mb-2">
      ...
      <SfSwitch
        v-model="enableGoogleSiteVerification"
...
const { updateSetting, getSetting } = useSiteSettings('enableGoogleSiteVerification');

const enableGoogleSiteVerification = computed({
  get: () => getSetting() === 'true',
